...
const DEEDS: Deed[] = [
  ...
  {
    client: "993 Restaurant & Bar",
    category: "Branding",
    title: "Markenauftritt & Website für Casual Dining",
    heroes: ["The Vector", "The Pixel Sorcerer", "The Quill"],
    result: "1 Brand",
    resultLabel: "Restaurant · Bar · Events",
    description:
      "Kompletter Auftritt für das 993 in Hannovers Südstadt: Logo im Skript-Stil, dunkle Farbwelt mit Rot- und Gold-Akzenten, Speisekarten, Reservierungs- und Event-Website.",
    accent: "#ffeb3b",
    video: deed05.url,
  },
  {
