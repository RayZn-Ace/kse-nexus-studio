...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "KSE GROUP baut Software, AI-Automationen, High-End Websites und Marketing-Systeme. Full-Service Tech- & Kreativ-Agentur aus Hannover." },
      { name: "author", content: "KSE Group" },
      { property: "og:title", content: "KSE GROUP — Software, AI & Digital Brands" },
      { property: "og:description", content: "Wenn es automatisiert, optimiert oder digitalisiert werden kann — wir bauen es." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "KSE GROUP — Software, AI & Digital Brands" },
      { name: "twitter:description", content: "Software, AI, Web, Marketing & Branding aus Hannover." },
